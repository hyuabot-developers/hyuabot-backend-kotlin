...
import app.hyuabot.backend.commuteShuttle.domain.ShuttleStopListResponse
import app.hyuabot.backend.commuteShuttle.domain.ShuttleStopResponse
...
class CommuteShuttleStopController {
    ...
    @Operation(
        summary = "통학버스 정류장 생성",
        description = "새로운 통학버스 정류장을 생성합니다.",
        requestBody =
            io.swagger.v3.oas.annotations.parameters.RequestBody(
                description = "통학버스 정류장 생성 요청",
    ...
    fun createShuttleStop(
        ...
        try {
            val createdStop = service.createStop(payload)
    ...
    @Operation(
        summary = "통학버스 정류장 조회",
        description = "특정 통학버스 정류장을 조회합니다.",
        parameters = [
            Parameter(
                name = "name",
                description = "통학버스 정류장 ID",
                required = true,
    ...
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200",
                description = "통학버스 정류장 조회 성공",
                content = [Content(schema = Schema(implementation = ShuttleStopResponse::class))],
            ),
            ApiResponse(
                responseCode = "404",
                description = "통학버스 정류장 없음",
                content = [
                    Content(
                        schema = Schema(implementation = ResponseBuilder.Message::class),
                        examples = [
    ...
    fun getShuttleStopByName(
        ...
        try {
            val stop = service.getStopByName(name)
    ...
    @Operation(
        summary = "통학버스 정류장 수정",
        description = "특정 통학버스 정류장을 수정합니다.",
        parameters = [
            Parameter(
                name = "name",
                description = "통학버스 정류장 ID",
    ...
    fun updateShuttleStop(
        ...
        try {
            val updatedStop = service.updateStop(name, payload)
            ResponseBuilder.response(
                HttpStatus.OK,
                ShuttleStopResponse(
    ...
    @Operation(
        summary = "통학버스 정류장 삭제",
        description = "특정 통학버스 정류장을 삭제합니다.",
        parameters = [
            Parameter(
                name = "name",
                description = "통학버스 정류장 ID",
